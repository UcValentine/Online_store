                        ...
                        <div class="desc1-right col-md-6 pl-lg-4">
                            ...
                            <div class="available mt-3">
                                <form action="#" method="post" class="w3layouts-newsletter">
                                    ...
                                    <button class="btn1">newsletter</button>

                                </form>
                                <a href="checkout.php" class="btn active">Checkout</a>
                    ...
                    <div class="row m-0">
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Suitable Lace Up </a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Black Flats</a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Elevator Shoes </a>
                                    </h4>
