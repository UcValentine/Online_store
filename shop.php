                    ...
                    <div class="deal-leftmk left-side">
                        ...
                        <div class="special-sec1 row mb-3">
                            ...
                            <div class="img-deal1 col-md-4">
                                ...
                                <a href="shop-single.php">$180.00</a>
                            </div>
                        ...
                        <div class="special-sec1 row">
                            ...
                            <div class="img-deal1 col-md-8">
                                ...
                                <a href="shop-single.php">$99.00</a>
                            </div>
                        ...
                        <div class="special-sec1 row my-3">
                            ...
                            <div class="img-deal1 col-md-8">
                                <h3>Bella Toes</h3>
                                <a href="shop-single.php">$165.00</a>
                            </div>
                        ...
                        <div class="special-sec1 row">
                            ...
                            <div class="img-deal1 col-md-8">
                                <h3>Red Bellies</h3>
                                <a href="shop-single.php">$225.00</a>
                            </div>
                        ...
                        <div class="special-sec1 row mt-3">
                            ...
                            <div class="img-deal1 col-md-8">
                                <h3>(SRV) Sneakers</h3>
                                <a href="shop-single.php">$169.00</a>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Bella Toes </a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Chikku Loafers </a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">(SRV) Sneakers </a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men my-lg-4">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Shuberry Heels</a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men my-lg-4">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Red Bellies </a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men my-lg-4">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Catwalk Flats </a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Running Shoes </a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Sukun Casuals </a>
                                    </h4>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="product-shoe-info shoe text-center">
                                ...
                                <div class="item-info-product">
                                    <h4>
                                        <a href="shop-single.php" class="btn active">Bank Sneakers</a>
                                    </h4>
